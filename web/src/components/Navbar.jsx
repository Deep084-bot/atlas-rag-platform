      ...
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-4 lg:px-8">
        ...
        >
          <svg width="18" height="18" viewBox="0 0 100 100" aria-hidden="true">
            ...
            <circle cx="50" cy="50" r="48" fill="none" stroke="url(#nav-logo-g)" strokeWidth="6" />
            <text x="50" y="68" fontFamily="system-ui" fontWeight="800" fontSize="48" fill="url(#nav-logo-g)" textAnchor="middle">A</text>
          </svg>
          ATLAS
        </Link>
          ...
          {auth.isLoading ? null : auth.user ? (
            <>
              ...
              {!isWorkspace && (
                <Link
                  to="/app"
                  className="rounded-lg bg-atlas-teal px-4 py-1.5 text-sm font-semibold text-slate-950 transition hover:bg-atlas-teal/90 focus-visible:outline-2 focus-visible:outline-atlas-teal"
                >
                  Workspace
                </Link>
              )}
