        ...
        <div className="relative z-10 w-full max-w-md text-center lg:text-left">
          <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl border border-atlas-teal/20 bg-atlas-teal/10 shadow-[0_0_24px_rgba(72,215,200,0.1)] lg:mx-0">
            <svg width="28" height="28" viewBox="0 0 100 100" aria-hidden="true">
              <defs>
                <linearGradient id="signup-logo" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#48d7c8" />
                  <stop offset="100%" stopColor="#7cc7ff" />
                </linearGradient>
              </defs>
              <circle cx="50" cy="50" r="48" fill="none" stroke="url(#signup-logo)" strokeWidth="6" />
              <text x="50" y="68" fontFamily="system-ui" fontWeight="800" fontSize="48" fill="url(#signup-logo)" textAnchor="middle">A</text>
            </svg>
          </div>
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12 lg:px-12">
        <div className="w-full max-w-sm">
          <div className="mb-8 flex items-center justify-center lg:hidden">
            <Link to="/" className="inline-flex items-center gap-2 text-sm font-bold tracking-[0.18em] text-white/90">
              <svg width="18" height="18" viewBox="0 0 100 100" aria-hidden="true">
                <defs>
                  <linearGradient id="signup-logo-m" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#48d7c8" />
                    <stop offset="100%" stopColor="#7cc7ff" />
                  </linearGradient>
                </defs>
                <circle cx="50" cy="50" r="48" fill="none" stroke="url(#signup-logo-m)" strokeWidth="6" />
                <text x="50" y="68" fontFamily="system-ui" fontWeight="800" fontSize="48" fill="url(#signup-logo-m)" textAnchor="middle">A</text>
              </svg>
              ATLAS
            </Link>
          </div>
          ...
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-8 shadow-[0_8px_32px_rgba(0,0,0,0.3)] backdrop-blur-sm">
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-atlas-teal/70">Get started</p>
            <h1 className="mt-2 text-2xl font-semibold tracking-tight text-white">Create your account</h1>

            <form onSubmit={handleSubmit} onKeyDown={handleKeyDown} className="mt-8 space-y-5">
              <div>
            ...
            <p className="mt-8 text-center text-sm text-slate-400">
              ...
              <Link to="/login" className="font-semibold text-atlas-sky underline underline-offset-2 hover:text-atlas-sky/80 transition-colors">
                Log in
              </Link>
            </p>
          </div>
